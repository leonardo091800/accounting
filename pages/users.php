...
foreach($rows as $row) {
	...
	<a onclick=\"window.location.href = '$root_Pages_storeSessionVariables_HTML?SESSION_what=usrSelected&SESSION_value={$row['id']}'; \"> <button class='selectButton'> SELECT </button> </a>
	</td><td> {$row['name']} 
	</td><td> {$row['surname']} 
